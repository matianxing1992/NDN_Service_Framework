...
| G4 | MEDIUM | T004/T012 | Updated 2026-09-07: normal runners, storage, terminal reconciliation and shared receiver/query recovery are wired; cross-machine transport, portable prerequisite evidence and negative runner remain incomplete. | Component evidence in t004-*.md. t004-operator-env.md records actual independent login environment and interpreter wiring; compute/runtime qualification still missing. Re-audit required. |
