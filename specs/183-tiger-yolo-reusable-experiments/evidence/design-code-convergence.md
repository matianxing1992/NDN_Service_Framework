...
| G4 | MEDIUM | T004/T012 | Updated 2026-09-07: local and normal single/two-node GPU private runners plus measured node-local storage are wired; remote staging, negative runner and terminal reconciliation remain incomplete. | See t004-local-owner-wiring.md, t004-single-gpu-runner.md, t004-two-node-runner.md and t004-node-storage.md for component evidence; no actual Slurm/GPU qualification, re-audit still required. |
