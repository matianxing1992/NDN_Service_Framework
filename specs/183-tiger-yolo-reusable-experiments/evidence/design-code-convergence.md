...
| G4 | MEDIUM | T004/T012 | Updated 2026-09-07: local and private single-GPU run are wired; remote staging, distributed/negative runner, scratch/capacity and terminal reconciliation remain incomplete. | See t004-local-owner-wiring.md and t004-single-gpu-runner.md for component evidence; no actual Slurm/GPU qualification, re-audit still required. |
