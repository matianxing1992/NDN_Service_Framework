...
| G4 | MEDIUM | T004/T012 | Updated 2026-09-07: local and normal single/two-node GPU private runners are wired; remote staging, negative runner, scratch/capacity and terminal reconciliation remain incomplete. | See t004-local-owner-wiring.md, t004-single-gpu-runner.md and t004-two-node-runner.md for component evidence; no actual Slurm/GPU qualification, re-audit still required. |
