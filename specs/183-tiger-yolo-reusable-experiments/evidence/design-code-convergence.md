...
| G4 | MEDIUM | T004/T012 | Updated 2026-09-07: normal runners, storage, terminal reconciliation and shared receiver submit/query recovery are wired; cross-machine transport, portable prerequisite evidence and negative runner remain incomplete. | Component evidence in t004-*.md, latest t004-shared-submit.md. Actual Tiger batch interpreter lacks jsonschema; pre-submit check now refuses it. No runtime qualification; re-audit required. |
