...
| G4 | MEDIUM | T004/T012 | Updated 2026-09-07: normal runners, storage, terminal reconciliation, shared receiver/query recovery and SSH transport are wired; negative runner and actual full-candidate qualification remain incomplete. | t004-ssh-coordinator.md adds actual 31-file login-node transport/reuse, not a Slurm/GPU gate. Component evidence in t004-*.md; compute/runtime qualification still missing. Re-audit required. |
