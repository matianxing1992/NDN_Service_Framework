...
| T006.c | T006 | 构建或复用稳定 base SIF，并在匹配 SDK/container 中构建只读 application bundle；记录 base/app 分层 hash | BLOCKED_AFTER_BOUNDARY | `evidence/application-bundle-r6-20260913.md` records the current-source local and staged read-only app bundle `04c2dd64b4f070cbd909a87f75a0372a0e3d4dae45c7e712641369cf76531d73`; source commit `6d143d3f0f7a7c627af2c1ef6810d79c0738b52d` and source seal `sha256:f4676a0f937c903caebc8374893171890d0d6d0639be42a3ced1b101d7512a00` are fixed; the current host M01 G3 manifest passes in `evidence/host-m01-r55-g3-20260913.md`, but no exact Spec186 source-sealed base SIF or composition receipt exists | build/verify the 1.5.3 source-sealed base SIF and verify the exact base+app composition; the host G3 receipt is the prerequisite, not the SIF result | base ABI重建；app-only仅重建 app |
