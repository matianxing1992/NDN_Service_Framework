...
### User Story 4 - Migrate Applications Without a Second Planner (Priority: P2)
...
| FR-009 / all | C-04 | T013,T014 | same-tree native process + source/ELF identity + final design comparison | evidence/b8-qualification.md |
...
[C-04 Validation](contracts/validation.md) · [Traceability](traceability.md) · [Quickstart](quickstart.md)
