...
| US5 / FR-020..FR-024 | maintained scripts and evidence checker | immutable tuple, event sequence, first boundary and verdict | C++ oracle output plus evidence checker | stale identity, timeout, partial logs | none; hash/event consistency | `evidence/b189-convergence.md` | B189-5 |
