...
| Row | Level | Covers | Evidence / cases | Status |
|---|---|---|---|---|
| RV-I35 | component | FR-017/019/036: pending withdrawal fences same-target retry and grant; recovery cannot mutate an already-published version or reactivate the old ABE pair | `PendingRotationFencesGrantAndPreservesImmutableStatus`: red10 failures; green36/36, retained-old-DKEY rejection and replacement-key success; included in final72/72 NDNSF integration gate | executed |
| RV-I36 | component | FR-038/SC-022 startup and FR-023/024 errors: constructors return without DKEY, admission waits for it, unwrap errors reach callbacks | Real constructors8/8; initial-DKEY/callback regression red4 failures, intermediate6/8, final8/8; final72/72 integration. Provider callback ownership mirrored in source; direct callback case uses real User Consumer | executed |
| RV-I37 | MiniNDN | FR-038/SC-022: explicit normal/post-exhaustion renewal, target-only DKEY refresh, every target/control outcome retained | Final normal10/10 +control24/24; late21/21 +control60/60;11/39 pre-resolution denials; each one target and zero unaffected DKEY refreshes; exhaustion<grant<renewal<first enqueue | executed, campaign-nac-final |
| RV-I38 | MiniNDN | FR-017/019/035/036: failed rotation and same-target recovery across four roles | Final14/14 checks, epoch2 failure/epoch3 recovery, denial throughout, no revoked success after failure, unaffected14/14 post-recovery; all five processes exit0 | executed, campaign-nac-final |
| RV-I39 | dependency component + MiniNDN | FR-019/023/024/036/041: old content/CK callbacks cannot cross invalidation; invalid-key errors cannot terminate a role | Delayed-fetch red5/green23 assertions, CP/KP error red2/green4, GDB old-library enum stack; NAC14/14 cases90 assertions, NDNSF182 unit/72 integration, MiniNDN16/16 with NAC8b462d0 | executed |
...
## Dependency compatibility follow-up (2026-09-05, T020)
