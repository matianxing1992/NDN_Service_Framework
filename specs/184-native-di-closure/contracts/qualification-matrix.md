...
| Current `NativeOfferAdmission::verify` C++ negative and immutable-view coverage (`Spec182OfferAdmission`, 18 cases / 81 assertions) | 182:T008, PO-013, FR-001/002/004/005/009, CD-003/004/013, INV-003/004 | same-tree admission selector passes; two frozen historical names remain contract-mapping gaps; ASan/UBSan, process/no-Python, real-model and external rows remain open | PARTIAL |
