...
| `T007-A3` Qwen3.6-27B | `WAITING_EXTERNAL_INPUT` | Exact `Qwen/Qwen3.6-27B` three-stage manifest, tokenizer, CUDA runtime and experiment-owner result; local 0.6B is smoke-only; the remote cache is incomplete at 1/15 shards and has no `refs/main`; host capability and selector boundaries are recorded in [T007 model capability evidence](../evidence/t007-model-capability-20260912.md) and [A4 external boundary](../evidence/a4-retirement-external-boundary-20260912.md) |
