...
| I02 | 182 native-isolation-design I02 | T006/T007 | canonical runner with fork-helper and renamed Python ELF counterfactual | exec/source identity violation rejected before business result | isolation / `asan-ubsan` / rejection boundary and no fallback | `DEV-76072468`; harness/config `UNFROZEN` | `tests/python/test_spec182_native_closure.py::test_helper_exec_rejected`; 71-test harness run in [B5 component evidence](../evidence/b5-component-validation-20260911.md) | PARTIAL |
| I03 | 182 native-isolation-design I03 | T006/T007 | runtime mapping detector | transient or renamed `libpython` mapping fails | isolation / `asan-ubsan` / complete mapping observation | `DEV-76072468`; runtime closure `UNFROZEN` | `tests/python/test_spec182_native_closure.py::test_transient_python_mapping_rejected`; 71-test harness run in [B5 component evidence](../evidence/b5-component-validation-20260911.md) | PARTIAL |
| I04 | 182 native-isolation-design I04 | T006/T007 | endpoint detector plus native requester/provider | host TCP/abstract UNIX/undeclared socket rejected while NFD allowlist works | isolation / `tsan` / declared endpoint-only communication | `DEV-76072468`; topology/config `UNFROZEN` | `tests/python/test_spec182_native_closure.py::test_undeclared_endpoint_rejected`; 71-test harness run in [B5 component evidence](../evidence/b5-component-validation-20260911.md) | PARTIAL |
| I05 | 182 native-isolation-design I05 | T006/T007 | trace and child collector | missing trace tail/short-lived child/observer kill is `UNQUALIFIED` | evidence / `none` / observation completeness and bounded result | `DEV-76072468`; harness digest `UNFROZEN` | `tests/python/test_spec182_native_closure.py::test_incomplete_observation_unqualified`; 71-test harness run in [B5 component evidence](../evidence/b5-component-validation-20260911.md) | PARTIAL |
| I06 | 182 native-isolation-design I06 | T006/T007 | cold native requester/provider process | warm-only model, harness-generated plan/text, or missing Provider fails | assembly / `asan-ubsan` / cold preparation, role coverage and independent oracle | `DEV-76072468`; model/config `UNFROZEN` | `tests/python/test_spec182_native_closure.py::test_cold_path_and_role_coverage_required`; 71-test harness run in [B5 component evidence](../evidence/b5-component-validation-20260911.md) | PARTIAL |
| I07 | 182 native-isolation-design I07 | T006/T007 | external Python harness with native business processes | harness Python is allowed; business owner must remain no-Python | isolation / `none` / process/library allowlist and owner evidence | `DEV-76072468`; process manifest `UNFROZEN` | `tests/python/test_spec182_native_closure.py::test_external_harness_excluded`; 71-test harness run in [B5 component evidence](../evidence/b5-component-validation-20260911.md) | PARTIAL |
| I08 | 182 native-isolation-design I08 | T006/T007 | process-group and descendant collector | detached/late child leaves no owned process or becomes `UNQUALIFIED` | lifetime / `tsan` / PID lineage and cleanup completeness | `DEV-76072468`; runner config `UNFROZEN` | `tests/python/test_spec182_native_closure.py::test_descendant_cleanup_required`; 71-test harness run in [B5 component evidence](../evidence/b5-component-validation-20260911.md) | PARTIAL |
