...
| Member | Bound value |
| --- | --- |
| `candidateId` | `sha256:bf301beb053db1a9823b23f767afe051ac95808d5eace8df4c417a263115d931` (digest over the ordered member map below; recompute if any listed member changes) |
