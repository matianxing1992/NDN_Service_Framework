...
- [ ] T180 [US1] Commit and push the audited T179 repair under a new source identity, create and verify a new source seal and source-bound Foundation digest, then require a fresh explicit human authorization before any new exactly-once GPU assembly dispatch; preserve all prior source/release identities per FR-002 and FR-027-FR-028 (partial, HIGH; depends on T179)
