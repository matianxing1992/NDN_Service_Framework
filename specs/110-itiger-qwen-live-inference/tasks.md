...
- [ ] T198 [US1] Commit and seal the final GPU-layer repair under a new source identity, reuse only the immutable source-bound `228341e` local Foundation through the explicit component binding, and execute T190 as a new local candidate without GHCR publication or iTiger submission (missing, HIGH; depends on T197)
