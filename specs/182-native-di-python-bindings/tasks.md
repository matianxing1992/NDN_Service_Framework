...
| [T003-C Placement and Registry](contracts/execution-units.md#t003-c-placement-and-registry) | PARTIAL | T003-A, T003-B | [placement repair](evidence/t003-role-placement-20260907.md)；逐角色独立 Provider、目标工件提示与预算拒绝已修复；37 cases PASS；完整 device/rank/residency proof 与 Python 对照仍待完成 | 2026-09-07 |
| [T004-A Canonical Plan Sealing](contracts/execution-units.md#t004-a-canonical-plan-sealing) | PARTIAL | T003-C | [binding repair](evidence/t004-artifact-grant-bindings-20260907.md)；真实工件/context→sealCore→grantView 修复；33 cases PASS；canonical wire/device/rank 与 T003-C 仍未闭合 | 2026-09-07 |
...
| [T008-A Native Input and Artifact Preparation](contracts/execution-units.md#t008-a-native-input-and-artifact-preparation) | PARTIAL | T003-C, T006-D, T007-B | [binding repair and placement audit](evidence/t004-artifact-grant-bindings-20260907.md)；T003-C 多角色分配与 residency 语义存在缺陷，依赖未闭合；既有局部 PASS 保留，整卡验收待修复 | 2026-09-07 |
| [T008-B Authenticated Offer Admission](contracts/execution-units.md#t008-b-authenticated-offer-admission) | PARTIAL | T008-A | [binding repair and placement audit](evidence/t004-artifact-grant-bindings-20260907.md)；T003-C 多角色分配与 residency 语义存在缺陷，依赖未闭合；既有局部 PASS 保留，整卡验收待修复 | 2026-09-07 |
