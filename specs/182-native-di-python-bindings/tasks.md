...
**Revision**: 89 | **Status**: DRAFT / T001 DONE
...
| [T016-A Local Qualification](contracts/execution-units.md#t016-a-local-qualification) | PARTIAL | T015-A | [R6-B4 preflight evidence](evidence/r6-b4-t016-preflight-20260908.md) + [R10-B38 recheck](evidence/r10-b38-t016-runtime-context-recheck-20260909.md)：当前主机虽有系统 `/run/nfd/nfd.sock`，仍无 MiniNDN node/netns metadata；默认 campaign 返回 exit 2 `UNQUALIFIED/MININDN_NODE_CONTEXT_NOT_PROVIDED`，显式 owner 模式在 UID 1000 返回 `UNQUALIFIED/MININDN_REQUIRES_ROOT`；未产生业务协议结果，完整 unit/integration/MiniNDN/no-Python matrix 仍未运行 | 2026-09-09 |
