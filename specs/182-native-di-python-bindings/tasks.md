...
| [T010-A Request Operation Terminal State](contracts/execution-units.md#t010-a-request-operation-terminal-state) | PARTIAL | T005-B, T008-B, T009-C | [lifecycle repair](evidence/t010-a-lifecycle-audit-20260907.md)；独立通知、close 后重放、提交失败终态；ClientState 3/3 与既有 2/2 PASS；完整 Core 请求/成功竞争、主动 deadline 与有界通知待完成 | 2026-09-07 |
