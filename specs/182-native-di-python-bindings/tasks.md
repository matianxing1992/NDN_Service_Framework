...
| [T008-A Native Input and Artifact Preparation](contracts/execution-units.md#t008-a-native-input-and-artifact-preparation) | PARTIAL | T003-C, T006-D, T007-B | [Core publisher](evidence/t008-core-artifact-publisher-20260907.md)；native ArtifactPort 复用 Core 加密 API，源身份及取消/超时/LocalMock 发布检查通过；65 cases/779 assertions PASS；实际 source inspection、模型发布配置、requester 接线和网络资格待完成 | 2026-09-07 |
