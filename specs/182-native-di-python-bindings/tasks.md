...
**Revision**: 23 | **Status**: DRAFT / T001 DONE
...
| [T013-A Maintained Caller Migration](contracts/execution-units.md#t013-a-maintained-caller-migration) | PARTIAL | T012-B | [R5-B3 caller audit](evidence/r5-b3-maintained-caller-audit-20260908.md)；R5-B5 已固定 native runtime config parser/fixture，R5-B6/R5-B8 已把维护中的 Qwen requester 接到显式 native payload 与 callback-aware full-generation route，并让固定 tiny streaming harness 对不兼容配置 fail-closed；YOLO user、native streaming execution、Provider retirement、真实请求与全量 migration 仍开放 | 2026-09-08 |
