...
| [T008-A Native Input and Artifact Preparation](contracts/execution-units.md#t008-a-native-input-and-artifact-preparation) | PARTIAL | T003-C, T006-D, T007-B | [V3 publication](evidence/t008-v3-artifact-publication-20260907.md)；端口直接消费 candidate/选定 V3 roles，逐项拒绝外来 artifact digest；58 cases/553 assertions PASS；真实 catalog/Repo owner、网络 publication 与 requester 主链待完成 | 2026-09-07 |
