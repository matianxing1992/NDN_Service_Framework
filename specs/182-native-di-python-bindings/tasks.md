...
| [T010-A Request Operation Terminal State](contracts/execution-units.md#t010-a-request-operation-terminal-state) | PARTIAL | T005-B, T008-B, T009-C | [deadline repair](evidence/t010-a-deadline-20260907.md)；独立 deadline/私有测试口、异步异常与预算校验；-j4 构建 PASS，ClientState 8/8、既有 2/2 PASS；完整 Core 请求/成功竞争、有界通知仍待完成 | 2026-09-07 |
