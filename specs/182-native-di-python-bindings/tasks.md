...
| [T004-A Canonical Plan Sealing](contracts/execution-units.md#t004-a-canonical-plan-sealing) | PARTIAL | T003-C | [graph identities](evidence/t008-graph-identity-spaces-20260907.md)；core 保留 planning/assembly 图身份，四场景 SDK core digest 与相关 58 cases/594 assertions PASS；发布后 manifest/recipe 重新认证、dataflow/device binding、requester 主链及完整验收仍待完成 | 2026-09-07 |
...
| [T008-A Native Input and Artifact Preparation](contracts/execution-units.md#t008-a-native-input-and-artifact-preparation) | PARTIAL | T003-C, T006-D, T007-B | [graph identities](evidence/t008-graph-identity-spaces-20260907.md)；planning/canonical graph 显式区分，V3 publication 保留双重身份；58 cases/594 assertions PASS；真实 source owner、发布前后 manifest/fetch 转换与 requester 主链待完成 | 2026-09-07 |
