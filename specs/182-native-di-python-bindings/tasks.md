...
| [T008-A Native Input and Artifact Preparation](contracts/execution-units.md#t008-a-native-input-and-artifact-preparation) | PARTIAL | T003-C, T006-D, T007-B | [publication recertification](evidence/t008-publication-recertification-20260907.md)；验证业务 root/source/initializer 身份，分开稳定名与 fetch 名；58 cases/710 assertions PASS；实际本地 source inspection、Core publisher 和 requester 接线待完成 | 2026-09-07 |
