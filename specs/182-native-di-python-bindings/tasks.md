...
| [T008-A Native Input and Artifact Preparation](contracts/execution-units.md#t008-a-native-input-and-artifact-preparation) | PARTIAL | T003-C, T006-D, T007-B | [inspection/roles](evidence/t008-inspection-roles-20260907.md)；实际来源/完整模型/manifest 与 role/rank/artifact/budget 绑定、相关 46 cases PASS；真实 catalog/Repo 端口实现、publication 与 requester 主链待完成 | 2026-09-07 |
