...
**Revision**: 20 | **Status**: DRAFT / T001 DONE
...
| [R5-B6 Qwen and Streaming Native Requesters](contracts/execution-units.md#r5-b6-qwen-and-streaming-native-requesters) | NOT_STARTED | R5-B5; R5-B6A; T011-C | [R5-B3 caller audit](evidence/r5-b3-maintained-caller-audit-20260908.md)：Qwen、streaming、conversation 入口仍使用 Python requester；R5-B6A 已固定 native option DTO binding 出口，待 native generation/stream/conversation 稳定出口后逐族迁移，Provider retirement 不纳入本卡 | 2026-09-08 |
...
R5-B5、R5-B6A 与 T011-C；当前 Qwen、streaming、conversation 仍由 Python requester 承担。
R5-B6A 已提供 native generation/stream/conversation option DTO binding，但必须先
