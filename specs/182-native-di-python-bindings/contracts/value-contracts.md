...
| NativeAckEvidence / NativeOfferBindingContext / NativeOfferPolicySnapshot / NativeSecurityPolicySnapshot | 持已有 Core 验证结果及所绑定 request/attempt/ControllerVersion；只读引用 owner 快照，不能接受 caller 声明的“已验证”。 | CD-013；O-004：生命周期、generation fence 与真实回调签名 |
