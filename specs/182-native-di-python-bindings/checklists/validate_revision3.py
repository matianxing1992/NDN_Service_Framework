#!/usr/bin/env python3
"""Read-only validation for the Spec182 revision 3 document contract."""
...
normative = [
    ...
    "checklists/requirements.md", "contracts/symbol-design.md", "contracts/value-contracts.md",
]
...
for prefix, count in [("FR", 17), ("SC", 9), ("CD", 14), ("PO", 14)]:
...
for task in ids:
    ...
    if block:
        for key in ["SymbolContracts", "Documentation", "Usage"]:
