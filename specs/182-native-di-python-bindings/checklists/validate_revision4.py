#!/usr/bin/env python3
"""Read-only validation for the Spec182 revision 4 document contract."""
...
for prefix, count in [("FR", 18), ("SC", 10), ("CD", 14), ("PO", 15)]:
...
for task in ids:
    ...
    if block:
        for key in ["SymbolContracts", "Documentation", "Usage", "StaticReview"]:
