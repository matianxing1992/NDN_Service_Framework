...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 838 行。\par
...
ndn::Name RequestServiceTargeted(const ndn::Name& provider,
                                 ...
                                 ResponseHandler onResponseHandler);
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 831 行。\par
...
ndn::Name RequestServiceTargeted(const ndn::Name& provider,
                                           ...
                                           int timeoutMs)
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 1118 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 971 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 1021 行。\par
...
std::shared_ptr<StreamedInvocationHandle<EventT, ResponseT>>
            RequestServiceStreaming(
                ...
                size_t strategy = ndn_service_framework::tlv::FirstResponding)
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 892 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 750 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 773 行。\par
