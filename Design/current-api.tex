...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 758 行。\par
...
ndn::Name RequestServiceTargeted(const ndn::Name& provider,
                                 ...
                                 ResponseHandler onResponseHandler);
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 751 行。\par
...
ndn::Name RequestServiceTargeted(const ndn::Name& provider,
                                           ...
                                           int timeoutMs)
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 1038 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 891 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 941 行。\par
...
std::shared_ptr<StreamedInvocationHandle<EventT, ResponseT>>
            RequestServiceStreaming(
                ...
                size_t strategy = ndn_service_framework::tlv::FirstResponding)
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 812 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 670 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 693 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{NDNSF-DistributedInference/cpp/ndnsf-di/NativePlanning.hpp}，第 279 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{NDNSF-DistributedInference/cpp/ndnsf-di/NativePlanning.hpp}，第 290 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{NDNSF-DistributedInference/cpp/ndnsf-di/NativeEpochCoordinator.hpp}，第 163 行。\par
