...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 824 行。\par
...
ndn::Name RequestServiceTargeted(const ndn::Name& provider,
                                 ...
                                 ResponseHandler onResponseHandler);
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 817 行。\par
...
ndn::Name RequestServiceTargeted(const ndn::Name& provider,
                                           ...
                                           int timeoutMs)
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 1104 行。\par
...
ServiceRegistration addScopedService(const ndn::Name& serviceName,
                                                 ...
                                                 ServiceMode mode);
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceProvider.hpp}，第 864 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceProvider.hpp}，第 873 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 957 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 1007 行。\par
...
std::shared_ptr<StreamedInvocationHandle<EventT, ResponseT>>
            RequestServiceStreaming(
                ...
                size_t strategy = ndn_service_framework::tlv::FirstResponding)
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 878 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 736 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{ndn-service-framework/ServiceUser.hpp}，第 759 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{NDNSF-DistributedInference/cpp/ndnsf-di/NativePlanning.hpp}，第 301 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{NDNSF-DistributedInference/cpp/ndnsf-di/NativePlanning.hpp}，第 312 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{NDNSF-DistributedInference/cpp/ndnsf-di/NativeRequestPreparation.hpp}，第 108 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{NDNSF-DistributedInference/cpp/ndnsf-di/NativeRequestPreparation.hpp}，第 116 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{NDNSF-DistributedInference/cpp/ndnsf-di/NativeRequestPreparation.hpp}，第 124 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{NDNSF-DistributedInference/cpp/ndnsf-di/NativeRequestPreparation.hpp}，第 131 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{NDNSF-DistributedInference/cpp/ndnsf-di/NativeEpochCoordinator.hpp}，第 167 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{NDNSF-DistributedInference/cpp/ndnsf-di/NativeConversationCoordinator.hpp}，第 105 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{NDNSF-DistributedInference/cpp/ndnsf-di/NativeConversationCoordinator.hpp}，第 126 行。\par
...
\end{Verbatim}
\textbf{源码：}\path{NDNSF-DistributedInference/cpp/ndnsf-di/NativeConversationCoordinator.hpp}，第 128 行。\par
...
void restore();
\end{Verbatim}
\textbf{源码：}\path{NDNSF-DistributedInference/cpp/ndnsf-di/NativeConversationCoordinator.hpp}，第 131 行。\par
