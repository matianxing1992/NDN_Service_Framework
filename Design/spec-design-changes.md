...
- **Source / evidence**: source checkpoints `689cca00d40b1e2bf241aff4e7d14b0204a7c892` and `90dc8785`; [Spec184 profile evidence](../specs/184-native-di-closure/evidence/minindn-environment-profile-20260912.md)、[environment profile guide](../docs/ndnsf-di-minindn-environment.md)。
