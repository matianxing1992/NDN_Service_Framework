...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 7 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 8 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 10 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 11 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 12 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 27 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 62 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 65 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 68 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 79 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 140 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 146 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 202 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 219 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 277 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 280 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 291 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 300 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 314 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 371 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 380 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 502 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 518 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1426 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1429 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1431 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1432 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1433 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1434 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1435 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1436 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1437 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1438 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1441 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1535 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1540 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1564 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1574 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1587 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1598 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1629 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1894 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1916 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1927 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1936 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1980 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 1994 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2032 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2155 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2161 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2226 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2232 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2238 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2245 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2251 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2257 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2263 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2269 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2278 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2284 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2302 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2308 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2314 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2320 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2326 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2332 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2338 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2394 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2438 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2533 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2615 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2634 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2671 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 2711 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4176 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4231 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4279 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4291 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4361 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4377 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4383 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4389 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4395 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4402 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4409 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4416 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4429 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4436 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4443 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4450 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4457 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4473 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4485 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4509 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4527 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4535 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4560 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4566 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4572 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4633 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneServiceContainer.inc.hpp`，第 4676 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneWindow.inc.hpp`，第 4 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/DroneWindow.inc.hpp`，第 7 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/UavCollaborationParticipant.hpp`，第 10 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/UavCollaborationParticipant.hpp`，第 13 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/UavCollaborationParticipant.hpp`，第 17 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/UavCollaborationParticipant.hpp`，第 18 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/UavCollaborationParticipant.hpp`，第 21 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/UavCollaborationParticipant.hpp`，第 31 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/drone/UavCollaborationParticipant.hpp`，第 35 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 16 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 18 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 19 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 20 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 23 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 25 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 26 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 27 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 28 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 29 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 30 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 31 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 34 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 57 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 59 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 60 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 61 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 62 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 65 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 67 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 68 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 69 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 70 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 73 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 90 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 92 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 93 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 94 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 95 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 96 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 97 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 100 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 102 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 103 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 104 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 105 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 106 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 107 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 108 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 109 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 111 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 126 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 128 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 129 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 130 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 131 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 132 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 133 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 134 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 135 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 136 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 137 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 139 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 140 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 141 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 142 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 143 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 144 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 145 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 146 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 147 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 148 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 150 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 156 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 164 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 170 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 180 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 197 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 199 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 201 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 202 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 203 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 204 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 205 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 206 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 207 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 208 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 209 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 210 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 213 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 214 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 215 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 216 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 217 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 218 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 219 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 220 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 222 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationRuntimeState.hpp`，第 229 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 4 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 7 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 104 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 109 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 144 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 187 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 203 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 209 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 215 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 221 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 233 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 240 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 299 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 305 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 312 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 318 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 324 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 331 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 337 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 343 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 350 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 361 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 388 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 398 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 406 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 415 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 422 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 430 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 437 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 444 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 450 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 456 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 458 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 459 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 460 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 463 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 488 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 495 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 502 行。
...
public / test-helper；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 522 行。
...
public / test-helper；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 543 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 552 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 579 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 591 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 597 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 643 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 654 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 665 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 675 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 685 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 692 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 699 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 731 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 744 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 776 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 964 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 979 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1007 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1018 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1031 行。
...
public / test-helper；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1042 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1055 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1066 行。
...
public / test-helper；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1077 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1102 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1113 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1136 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1148 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1168 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1198 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1204 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1247 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1253 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1259 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1266 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1273 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1280 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1287 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1293 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1315 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1321 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1327 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1334 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1340 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1346 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1357 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1368 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1379 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1390 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1460 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1466 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1472 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1615 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1717 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1776 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1933 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 1995 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2136 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2147 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2225 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2270 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2293 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2318 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2368 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2397 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2425 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2476 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2520 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2548 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2598 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2672 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2756 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2827 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2904 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 2987 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 3097 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 3303 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 3618 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 3630 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 3642 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 3652 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 3660 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 3675 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 3763 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 3977 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 4358 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationServiceContainer.inc.hpp`，第 9457 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationWindow.inc.hpp`，第 4 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationWindow.inc.hpp`，第 7 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/GroundStationWindow.inc.hpp`，第 1508 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 14 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 16 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 17 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 18 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 19 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 20 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 21 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 24 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 26 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 27 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 28 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 29 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 30 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 31 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 32 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 33 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 36 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 38 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 45 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 48 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 52 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 54 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 55 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 58 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 59 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 60 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 61 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 62 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 64 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 66 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 68 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 70 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 75 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 77 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 78 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/ground-station/UavIncidentCoordinator.hpp`，第 79 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 13 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 15 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 16 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 17 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 18 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 19 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 22 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 24 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 29 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 30 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 33 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 35 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 36 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 37 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 38 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavCollaborationPolicy.hpp`，第 46 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 16 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 18 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 19 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 20 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 21 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 22 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 23 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 26 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 28 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 29 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 30 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 40 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 42 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 43 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 44 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 45 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 46 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 47 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 49 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 57 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 60 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 62 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 63 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 65 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 69 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 79 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 91 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 97 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDetectorProvider.hpp`，第 105 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 16 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 18 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 19 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 20 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 21 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 22 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 23 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 24 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 25 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 26 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 27 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 28 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 31 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 33 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 35 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 36 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 37 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 38 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 39 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 40 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 41 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 42 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 43 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 44 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 45 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 46 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 50 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 53 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 56 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 57 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 58 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 59 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 61 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 62 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 77 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 80 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 85 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 86 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 87 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 88 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 89 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavDiagnostics.hpp`，第 90 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 18 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 21 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 24 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 29 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 31 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 32 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 33 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 34 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 35 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 37 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 38 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 40 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 41 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 45 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 48 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 49 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 51 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 52 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 53 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 56 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 57 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 60 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 63 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 64 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 65 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 66 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 69 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMissionSession.hpp`，第 70 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 14 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 15 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 16 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 18 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 20 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 21 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 22 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 23 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 24 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 25 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 26 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 27 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 28 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 31 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 32 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 35 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 37 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 38 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 39 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 40 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 41 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 42 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 43 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 44 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 45 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 47 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 48 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 49 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 53 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 55 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 56 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 57 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 58 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 59 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 60 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 61 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 62 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 63 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 64 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 65 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 66 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 68 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 71 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 73 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 74 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 75 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 76 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 77 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 78 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 79 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 80 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 81 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 82 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 83 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 84 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 86 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 88 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 89 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 90 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 91 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 94 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 96 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 97 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 98 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 99 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 100 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 101 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 103 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 104 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 105 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 109 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 111 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 112 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 113 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 114 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 115 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 116 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 117 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 118 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 119 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 120 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 121 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 122 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 123 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 124 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 125 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 126 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 127 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 128 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 129 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 130 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 131 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 132 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 133 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 135 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 138 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 139 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 140 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 141 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 144 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 146 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 147 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 148 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 149 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 150 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 151 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 153 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 156 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 158 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 159 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 160 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 161 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 162 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 163 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 166 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 169 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 170 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 178 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 181 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 188 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavMultiViewRecognition.hpp`，第 195 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 11 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 12 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 13 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 14 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 15 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 17 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 18 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 19 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 20 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 21 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 22 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 23 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 24 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 25 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 26 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 27 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 28 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 29 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 30 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 31 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 32 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 33 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 34 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 36 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 38 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 39 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 40 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 41 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 42 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 43 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 44 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 45 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 46 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 47 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 48 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 49 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 50 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 51 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 52 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 53 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 54 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 55 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 56 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 57 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 58 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 59 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 60 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 63 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 66 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 73 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 81 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 88 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 96 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 103 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 114 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 121 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 124 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 127 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 130 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 133 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 136 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 139 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 142 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 145 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 148 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 151 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 154 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 157 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 160 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 163 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavNames.hpp`，第 166 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 18 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 24 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 26 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 27 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 28 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 29 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 30 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 31 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 32 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 33 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 34 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 35 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 38 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 41 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 44 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 46 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 47 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 48 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 49 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 50 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 51 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 54 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 57 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 60 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 62 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 63 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 64 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 65 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 66 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 67 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 68 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 69 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 70 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 71 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 72 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 73 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 76 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 79 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 82 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 84 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 85 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 86 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 87 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 88 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 89 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 92 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 94 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 95 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 96 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 97 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 98 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 99 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 100 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 101 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 102 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 103 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 104 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 105 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 107 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 108 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 117 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 122 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 124 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 125 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 126 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 127 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 128 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 129 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 130 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 131 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 132 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 135 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 137 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 138 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 139 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 140 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 141 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 142 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 143 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 144 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 145 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 148 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 150 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 151 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 152 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 153 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 154 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 155 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 156 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 157 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 158 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 159 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 162 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 164 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 165 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 166 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 167 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 170 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 172 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 173 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 174 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 175 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 176 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 177 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 178 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 179 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 180 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 181 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 182 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 183 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 184 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 185 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 188 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 190 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 191 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 192 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 193 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 194 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 195 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 196 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 197 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 198 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 199 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 200 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 201 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 202 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 204 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 207 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 209 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 210 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 211 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 212 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 213 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 214 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 215 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 216 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 217 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 218 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 219 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 222 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 223 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 224 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 227 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 240 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 242 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 243 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 244 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 245 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 246 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 247 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 248 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 249 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 250 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 251 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 252 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 253 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 254 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 255 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 256 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 257 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 258 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 259 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 260 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 261 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 262 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 266 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 270 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 274 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 279 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 285 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 298 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 301 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 303 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 304 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 309 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 310 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 311 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 312 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 313 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 314 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 333 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 335 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 336 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 337 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 338 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 343 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 348 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 354 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 359 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 366 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 374 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 375 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 376 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 377 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 378 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 379 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 380 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 381 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 382 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 383 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 384 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 388 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 390 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 391 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 392 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 393 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 394 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 395 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 396 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 397 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 398 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 400 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 401 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 404 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 407 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 409 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 411 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 412 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 435 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 437 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 438 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 439 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 440 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 441 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 442 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 443 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 444 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 445 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 446 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 447 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 448 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 449 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 450 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 451 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 452 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 453 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 454 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 455 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 456 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 457 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 458 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 459 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 460 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 461 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 462 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 463 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 464 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 467 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 470 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 474 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 476 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 477 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 478 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 479 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 480 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 481 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 482 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 483 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 484 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 485 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 486 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 487 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 488 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 489 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 490 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 491 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 492 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 493 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 494 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 495 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 496 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 497 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 498 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 499 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 500 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 501 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 502 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 503 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 504 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 505 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 506 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 507 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 508 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 509 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 510 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 511 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 512 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 513 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 514 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 515 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 516 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 517 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 518 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 520 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 521 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 522 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 523 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 524 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 525 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 526 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 527 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 530 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 532 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 533 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 534 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 535 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 536 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 537 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 538 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 539 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 540 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 541 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 542 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 543 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 545 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 546 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 547 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 548 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 549 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 550 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 551 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 552 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 553 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 556 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 558 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 559 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 560 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 561 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 562 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 563 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 564 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 565 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 566 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 567 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 568 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 569 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 570 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 572 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 576 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 581 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 582 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 583 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 584 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 585 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 586 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 589 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 591 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 592 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 593 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 594 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 595 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 596 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 597 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 598 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 599 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 600 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 601 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 603 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 604 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 605 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 606 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 607 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 608 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 611 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 613 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 614 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 615 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 616 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 617 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 618 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 619 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 620 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 621 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 622 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 623 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 624 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 625 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 626 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 627 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 628 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 629 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 630 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 631 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 632 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 633 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 635 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 638 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 639 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 642 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 644 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 645 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 646 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 647 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 648 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 649 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 650 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 651 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 652 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 653 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 654 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 655 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 656 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 657 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 658 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 659 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 660 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 661 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 663 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 664 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 667 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 669 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 670 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 671 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 672 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 673 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 674 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 675 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 676 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 677 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 679 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 680 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 681 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 682 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 683 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 684 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 685 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 688 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 690 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 691 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 692 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 693 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 694 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 695 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 696 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 697 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 698 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 699 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 700 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 701 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 702 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 703 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 704 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 705 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 706 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 707 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 708 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 709 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 710 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 711 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 712 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 713 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 714 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 716 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 717 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 718 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 719 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 722 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 724 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 725 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 726 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 727 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 728 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 730 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 733 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 736 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 738 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 739 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 740 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 741 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 742 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 743 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 744 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 745 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 746 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 747 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 748 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 749 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 750 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 751 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 752 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 753 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 754 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 755 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 756 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 757 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 758 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 759 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 760 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 761 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 762 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 763 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 764 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 765 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 766 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 767 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 768 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 769 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 770 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 771 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 772 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 773 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 774 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 775 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 776 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 777 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 778 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 779 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 781 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 782 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 783 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 784 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 785 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 789 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 793 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 794 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 803 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 805 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 806 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 807 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 809 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 810 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 814 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 817 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 819 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 820 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 821 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 822 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 823 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 824 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 825 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 826 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 827 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 828 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 829 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 830 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 831 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 832 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 833 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 834 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 835 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 836 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 839 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 841 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 842 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 843 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 844 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 845 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 846 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 847 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 848 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 849 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 850 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 851 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 852 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 853 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 854 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 855 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 856 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 859 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 862 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 864 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 865 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 866 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 867 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 868 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 869 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 870 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 872 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 874 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 875 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 876 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 877 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 880 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 883 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 885 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 886 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 887 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 888 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 891 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 893 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 894 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 895 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 899 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 901 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 902 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 903 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 904 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 905 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 906 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 907 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 908 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 909 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 910 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 911 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 912 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 913 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 914 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 915 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 916 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 917 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 918 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 919 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 920 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 923 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 924 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 925 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 926 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 927 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 928 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 930 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 931 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 932 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 936 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 938 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 939 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 940 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 941 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 942 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 943 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 944 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 945 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 946 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 947 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 948 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 949 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 950 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 952 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 953 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 956 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 958 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 959 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 960 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 961 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 962 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 963 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 964 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 965 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 966 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 967 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 969 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 970 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 971 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 972 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 973 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 974 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 975 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 976 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 977 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 978 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 979 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 980 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 981 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 982 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 983 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 984 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 987 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 989 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 990 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 991 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 992 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 993 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 994 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 995 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 996 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 997 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 999 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1002 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1005 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1007 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1008 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1009 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1010 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1011 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1012 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1013 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1014 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1015 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1016 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1017 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1018 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1019 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1020 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1021 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1023 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1024 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1025 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1026 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1027 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1028 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1029 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1032 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1034 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1035 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1037 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1040 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1042 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1043 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1044 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1045 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1046 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1048 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1049 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1050 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1051 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1052 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1053 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1056 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1058 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1059 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1060 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1061 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1062 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1063 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1064 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1065 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1066 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1067 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1068 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1069 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1070 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1071 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1072 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1073 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1074 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1075 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1076 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1077 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1078 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1079 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1080 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1081 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1082 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1084 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1089 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1092 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1094 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1095 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1096 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1097 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1098 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1099 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1101 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1106 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1109 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1111 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1113 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1114 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1115 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1116 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1117 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1118 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1119 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1120 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1121 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1122 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1123 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1124 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1125 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1126 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1127 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1128 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1129 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1130 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1131 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1132 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1133 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1134 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1135 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1136 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1137 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1138 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1139 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1140 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1142 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1159 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1176 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1178 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1179 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1180 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1181 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1182 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1183 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1184 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1185 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1187 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1188 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1189 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1190 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1193 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1195 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1196 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1197 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1198 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1199 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1201 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1202 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1205 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1207 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1208 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1209 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1210 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1211 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1212 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1213 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1214 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1215 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1216 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1217 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1218 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1219 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1220 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1221 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1222 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1223 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1224 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1225 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1226 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1227 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1228 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1229 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1231 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1241 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1244 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1246 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1247 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1248 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1249 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1250 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1251 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1252 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1254 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1255 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1261 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1262 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1263 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1264 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1267 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1269 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1270 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1271 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1272 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1273 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1274 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1275 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1277 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1278 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1283 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1284 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1285 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1286 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1289 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1291 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1292 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1293 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1294 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1295 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1296 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1297 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1298 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1300 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1301 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1308 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1309 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1310 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1311 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1314 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1316 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1317 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1318 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1319 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1320 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1321 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1322 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1323 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1324 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1325 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1327 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1332 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1333 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1334 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1335 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1336 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1339 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1342 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1345 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1347 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1348 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1349 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1350 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1351 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1352 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1353 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1354 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1355 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1356 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1357 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1359 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1360 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1361 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1364 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1365 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1366 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1367 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1370 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1372 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1373 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1374 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1375 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1376 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1377 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1378 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1379 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1380 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1382 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1383 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1384 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1385 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1388 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1390 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1391 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1392 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1393 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1394 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1395 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1396 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1397 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1398 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1399 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1400 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1402 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1403 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1404 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1405 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1408 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1410 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1411 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1412 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1413 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1414 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1415 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1416 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1417 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1418 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1419 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1420 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1421 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1423 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1424 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1425 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1426 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1429 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1431 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1432 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1433 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1434 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1435 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1436 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1437 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1438 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1439 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1441 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1442 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1443 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1444 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1445 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1448 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1450 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1451 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1452 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1453 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1454 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1455 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1456 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1458 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1459 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1460 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1461 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1464 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1466 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1467 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1468 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1469 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1470 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1471 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1472 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1473 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1475 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1476 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1477 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1478 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1481 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1483 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1484 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1485 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1486 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1487 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1488 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1489 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1490 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1491 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1492 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1493 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1494 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1495 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1496 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1497 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1498 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1499 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1500 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1501 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1502 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1504 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1505 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1506 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1507 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1510 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1512 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1513 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1514 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1515 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1516 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1517 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1518 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1520 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1521 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1522 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1523 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1527 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1530 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1532 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1533 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1534 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1535 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1536 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1537 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1539 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1540 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1541 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1542 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1545 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1554 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1560 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1566 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1572 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1578 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1581 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1584 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1587 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1590 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1597 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1601 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1604 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1607 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1611 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1615 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1620 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1626 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1632 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1635 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1638 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1641 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1644 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1647 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1650 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1653 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1657 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1660 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1663 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1668 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1671 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1674 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1677 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1682 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1690 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1694 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavProtocol.hpp`，第 1697 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 15 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 16 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 18 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 20 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 21 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 22 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 23 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 24 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 25 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 26 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 27 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 28 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 29 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 31 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 32 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 35 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 36 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 40 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 42 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 43 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 44 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 45 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 46 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 47 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 48 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 49 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 53 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 56 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 57 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 59 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 60 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 61 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 62 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 73 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 75 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 76 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 77 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 78 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 79 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 81 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 82 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 85 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 86 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 90 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 93 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 95 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 96 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 97 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 98 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 99 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 102 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 104 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 105 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 106 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 107 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 108 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 112 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 115 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 116 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 120 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 121 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 122 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 141 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavSensorStreams.hpp`，第 146 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 15 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 17 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 18 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 19 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 20 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 23 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 25 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 26 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 27 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 28 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 29 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 30 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 31 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 34 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 36 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 37 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 38 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 39 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 42 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 44 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 45 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 46 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 47 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 48 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 49 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 50 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 53 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 55 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 56 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 57 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 60 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 63 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 65 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 66 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 67 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 68 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 83 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 86 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 88 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 90 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 91 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 92 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 93 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 95 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 96 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 105 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 107 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 108 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 109 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 110 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 111 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 112 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 115 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 117 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 118 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 121 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 124 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 126 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 129 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 130 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 131 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 132 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 133 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 134 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 135 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 149 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 152 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 154 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 155 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 156 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 157 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 159 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 160 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 161 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 162 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 163 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 164 行。
...
public / application-internal；冻结源码：`NDNSF-UAV-APP/shared/UavVideoPipeline.hpp`，第 165 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/evaluate_multiview_recognition.py`，第 31 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/evaluate_multiview_recognition.py`，第 35 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/evaluate_multiview_recognition.py`，第 39 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/evaluate_multiview_recognition.py`，第 43 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/evaluate_multiview_recognition.py`，第 51 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/evaluate_multiview_recognition.py`，第 55 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/evaluate_multiview_recognition.py`，第 76 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/evaluate_multiview_recognition.py`，第 183 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/minindn_multiview_node.py`，第 35 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/minindn_multiview_node.py`，第 39 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/minindn_multiview_node.py`，第 43 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/minindn_multiview_node.py`，第 47 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/minindn_multiview_node.py`，第 52 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/minindn_multiview_node.py`，第 61 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/minindn_multiview_node.py`，第 81 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/minindn_multiview_node.py`，第 198 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/minindn_multiview_node.py`，第 434 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/minindn_multiview_node.py`，第 557 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 33 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 46 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 47 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 48 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 49 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 50 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 51 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 52 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 53 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 54 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 55 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 57 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 74 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 93 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 94 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 95 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 96 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 97 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 98 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 99 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 100 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 101 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 102 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 103 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 104 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 106 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 125 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 154 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 211 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 246 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 251 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_contract.py`，第 256 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_recognition_worker.py`，第 51 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_recognition_worker.py`，第 55 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_recognition_worker.py`，第 87 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_recognition_worker.py`，第 88 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_recognition_worker.py`，第 99 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_recognition_worker.py`，第 151 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/multiview_recognition_worker.py`，第 259 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/mvcnn_model.py`，第 16 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/mvcnn_model.py`，第 19 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/mvcnn_model.py`，第 32 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/mvcnn_model.py`，第 50 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/mvcnn_onnx_worker.py`，第 34 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/mvcnn_onnx_worker.py`，第 38 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/mvcnn_onnx_worker.py`，第 46 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/mvcnn_onnx_worker.py`，第 53 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/mvcnn_onnx_worker.py`，第 63 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/mvcnn_onnx_worker.py`，第 127 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/mvcnn_onnx_worker.py`，第 261 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/prepare_coperception_uav.py`，第 20 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/prepare_memphis_offline_map.py`，第 25 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/prepare_memphis_offline_map.py`，第 33 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/prepare_memphis_offline_map.py`，第 52 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/prepare_mvcnn_artifact.py`，第 33 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/prepare_mvcnn_artifact.py`，第 41 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/prepare_mvcnn_artifact.py`，第 45 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/prepare_mvcnn_artifact.py`，第 75 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/prepare_mvcnn_artifact.py`，第 106 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/prepare_mvcnn_artifact.py`，第 134 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/prepare_mvcnn_artifact.py`，第 148 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_multiview_fixture.py`，第 15 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_multiview_minindn.py`，第 38 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_multiview_minindn.py`，第 45 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_multiview_minindn.py`，第 53 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_multiview_minindn.py`，第 68 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_multiview_minindn.py`，第 113 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_multiview_minindn.py`，第 342 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_multiview_minindn.py`，第 517 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_multiview_minindn.py`，第 522 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_multiview_minindn.py`，第 526 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_px4_sitl_scenario.py`，第 34 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_px4_sitl_scenario.py`，第 42 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_px4_sitl_scenario.py`，第 51 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_px4_sitl_scenario.py`，第 55 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_px4_sitl_scenario.py`，第 107 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/run_uav_px4_sitl_scenario.py`，第 196 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 22 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 27 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 41 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 48 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 57 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 58 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 62 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 65 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 69 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 74 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 83 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 95 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 110 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 128 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 145 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 160 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 168 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 208 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 221 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 231 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 263 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 279 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 303 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/uav_deployment_check.py`，第 324 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/yolo_detect_once.py`，第 16 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/yolo_detect_once.py`，第 20 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/yolo_detect_worker.py`，第 17 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/yolo_detect_worker.py`，第 21 行。
...
public-by-name / application-internal；冻结源码：`NDNSF-UAV-APP/tools/yolo_detect_worker.py`，第 60 行。
