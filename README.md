...
`run_token_handshake_negative_regression.sh` verifies rejection of ACKs and responses with wrong `UserToken` values and coordination messages with wrong `ProviderToken` values.
