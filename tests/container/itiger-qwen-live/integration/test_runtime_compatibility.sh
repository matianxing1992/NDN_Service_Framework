...
base={
 ...
 'imports':{x:True for x in ('ndnsf','ndnsf_distributed_inference','onnxruntime','tokenizers')},
 'missingLibraries':[], 'driverVersion':'550.54.15',
 ...
 'allocatedGpuUuid':'GPU-a', 'ortGpuUuid':'GPU-a'}
...
cases=[
 ...
 ('ort-cuda-mismatch',lambda x:x.update(ortCudaVersion='11.8'),'FAIL_CUDA_MAJOR_MISMATCH')]
