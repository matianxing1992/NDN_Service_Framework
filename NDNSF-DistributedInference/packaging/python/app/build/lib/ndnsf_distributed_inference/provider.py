...
from .core import (
    ...
    DIRequestEnvelopeV2, DISelectionParticipant, GpuMiBAdmissionLedger,
    ...
    def issue(
        ...
        with self._lock:
            ...
            evidence = {
                ...
                "accepted_roles": tuple(accepted_roles),
        ...
        *,
        ...
        def ack(context: Mapping[str, object], _payload: bytes) -> AckDecision:
            ...
            if (isinstance(request_document, dict)
                ...
                try:
                    DIRequestEnvelopeV2.from_bytes(_payload)
            ...
            if v2_request:
                ...
                return selection_offer_issuer.issue(
