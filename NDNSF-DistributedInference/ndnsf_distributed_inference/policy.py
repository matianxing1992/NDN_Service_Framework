...
class DistributedInferenceDeployment:
    ...
    def require_executable_artifacts_allowed(self) -> None:
        missing = []
        if not self.trust_anchor_file:
            missing.append("trust.anchor_file")
...
""")
        ...
        blocks.append("""
; Demo/local bootstrap default. Production deployments should set
; trust.anchor_file in the high-level policy config.
trust-anchor
{
  type any
}
