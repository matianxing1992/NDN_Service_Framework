...
class AutomaticPlanningCoordinator:
    ...
    def request(
        ...
        *,
        ...
        # Core represents request identifiers as canonical absolute NDN-name
        # URIs.  Normalize before encoding the DI Request so the ACK offer and
        # the later Core-owned Selection bind to the same exact identifier.
