...
class NodeProto : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:onnx.NodeProto) */ {
 ...
 private:
  ...
  void set_has_overload();
  void clear_has_overload();
  void set_has_doc_string();
  void clear_has_doc_string();
...
class TypeProto_Opaque : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:onnx.TypeProto.Opaque) */ {
 public:
  TypeProto_Opaque();
...
inline void NodeProto::set_has_overload() {
  _has_bits_[0] |= 0x00000010u;
}
inline void NodeProto::clear_has_overload() {
  _has_bits_[0] &= ~0x00000010u;
}
...
inline ::std::string* NodeProto::release_overload() {
  ...
  clear_has_overload();
  return overload_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline void FunctionProto::set_has_overload() {
  _has_bits_[0] |= 0x00000008u;
}
inline void FunctionProto::clear_has_overload() {
  _has_bits_[0] &= ~0x00000008u;
}
