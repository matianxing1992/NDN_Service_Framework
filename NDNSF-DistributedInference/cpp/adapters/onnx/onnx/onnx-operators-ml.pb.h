...
class OperatorProto : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:onnx.OperatorProto) */ {
 public:
  OperatorProto();
...
class OperatorSetProto : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:onnx.OperatorSetProto) */ {
 public:
  OperatorSetProto();
