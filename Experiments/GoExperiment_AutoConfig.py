...
if __name__ == '__main__':
    ...
    memphis.cmd('xterm -T "memphis" -e "syncps /muas/memphis > /tmp/memphis.log 2>&1" &')

    ucla.cmd('xterm -T "ucla" -e "syncps /muas/ucla > /tmp/ucla.log 2>&1" &')


    # ndnsf-experiments /muas/drone1
