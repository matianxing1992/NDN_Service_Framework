#!/usr/bin/env python3
"""Freeze and execute the immutable two-cell Spec 150 campaign."""
...
ANALYZER = ROOT / "Experiments/analyze_spec150_predictive_ordered_drain.py"
...
BASE.BASE.SOURCE_PATHS = tuple(Path(value) for value in (
    ...
    "specs/150-predictive-ordered-drain-progress/spec.md",
    "specs/150-predictive-ordered-drain-progress/plan.md",
    "specs/150-predictive-ordered-drain-progress/tasks.md",
    "specs/150-predictive-ordered-drain-progress/contracts/ordered-drain.md",
...
def replace_schema(value: Any) -> Any:
    if isinstance(value, str):
        return value.replace(
            ...
            "spec150-predictive-ordered-drain",
        )
