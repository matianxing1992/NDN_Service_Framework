...
NDN_SVS_REVISION = "1d432a5b1ffde64544963a86fda9163ccc26610e"
...
def run(workspace: Path, seal_root: Path | None) -> dict[str, object]:
    ...
    require(onnx_cpp.get("version") == "1.20.0", "PREFLIGHT_ONNX_CPP_VERSION_INVALID")
    require(onnx_cpp.get("sha256") == "80461c14d3562b02268bbd7e97f9bceab0778090ce0a0e298bb999c388076d9a", "PREFLIGHT_ONNX_CPP_DIGEST_INVALID")
    require(onnx_cpp.get("bytes") == 258494029, "PREFLIGHT_ONNX_CPP_SIZE_INVALID")
    require(
