...
\node[font=\footnotesize,text width=12cm] at (5.1,-2.1) {Controller: authorization material and signed status.\\Sync: discover names. Interests: retrieve Data. Validators: check accepted objects and local state.};
\end{tikzpicture}
