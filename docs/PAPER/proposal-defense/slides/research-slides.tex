...
\begin{enumerate}
\item Keep discovery descriptors non-public before participating Providers are identified.
...
\begin{enumerate}
\item Revised design: publish new public parameters as signed Named Data; Sync announces availability.
...
\begin{frame}{What the Multi-View Workflow Must Demonstrate}
\begin{itemize}
...
\begin{frame}{Map Application Functions to Framework Evidence}
\begin{enumerate}
...
\end{enumerate}
\vspace{3mm}\bluebox{UAV and DI cover discovery, authorization, data delivery, lifecycle, and collaboration. Local calls do not prove remote behavior. Representative workflows cover claimed mechanisms; optional application features need not become separate dissertation gates.}
\end{frame}
