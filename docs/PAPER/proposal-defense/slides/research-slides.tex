...
Named Data and signatures [1] & Validate signatures and signing-key relationships under trust rules; check task permissions separately\\\midrule
...
\end{itemize}
\vspace{3mm}\bluebox{This avoids a separate role-based invocation policy in NDNSF. It does not eliminate key updates or prove lower total cost; role-based designs can also reuse credentials.}
\end{frame}
...
\begin{itemize}
\item \textbf{RQ1 answer:} when ABE-encrypted discovery and ABE-backed service authorization justify their management and revocation costs.
