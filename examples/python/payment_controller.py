#!/usr/bin/env python3
"""Run only the controller role for the payment collaboration example."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the payment ServiceController")
    parser.add_argument("--policy-file", default="examples/payment_collaboration.policies")
...
def main() -> int:
    ...
    config = ControllerConfig(name="payment-controller", policy_file=args.policy_file)
