#!/usr/bin/env python3
"""Run only the user role for the distributed AI example."""
...
def user_config(timeout_ms: int, ack_timeout_ms: int) -> UserConfig:
    return UserConfig(
        name="ai-user",
        binary="AI_User",
        args=(
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the AI collaboration user")
...
def main() -> int:
    ...
    config = user_config(args.timeout_ms, args.ack_timeout_ms)
