#!/usr/bin/env python3
"""ServiceController for the PyTorch eager 2x2 example."""
...
def main() -> int:
    parser = parse_args_with_common("Run PyTorch eager 2x2 controller")
    ...
    if args.dry_run:
        print("Run PyTorch eager 2x2 controller")
